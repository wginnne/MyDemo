...
You can also more options via the 'target' option: 'browserslist' / 'browserslist:env' / 'browserslist:query' / 'browserslist:path-to-config' / 'browserslist:path-to-config:env'`);
        ...
        "object" == typeof rspackFuture && (D(rspackFuture, "bundlerInfo", {}), "object" == typeof rspackFuture.bundlerInfo && (D(rspackFuture.bundlerInfo, "version", "1.6.7-canary-63b4dae2-20251204065915"), D(rspackFuture.bundlerInfo, "bundler", "rspack"), D(rspackFuture.bundlerInfo, "force", !library)));
    ...
    let CORE_VERSION = "1.6.7-canary-63b4dae2-20251204065915", bindingVersionCheck_errorMessage = (coreVersion, expectedCoreVersion)=>process.env.RSPACK_BINDING ? `Unmatched version @rspack/core@${coreVersion} and binding version.
...
`;
    ...
    class MultiStats {
        ...
        toJson(options) {
            ...
            }), childOptions.version && (obj.rspackVersion = "1.6.7-canary-63b4dae2-20251204065915", obj.version = "5.75.0"), childOptions.hash && (obj.hash = obj.children.map((j)=>j.hash).join(""));
            let mapError = (j, obj)=>({
                    ...obj,
    ...
    let iterateConfig = (config, options, fn)=>{
        ...
        compilation: {
            ...
            version: (object)=>{
                object.version = "5.75.0", object.rspackVersion = "1.6.7-canary-63b4dae2-20251204065915";
            },
    ...
    let exports_rspackVersion = "1.6.7-canary-63b4dae2-20251204065915", exports_version = "5.75.0", exports_WebpackError = Error, sources = __webpack_require__("webpack-sources"), exports_config = {
